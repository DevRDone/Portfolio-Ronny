...
import maviImg from "../assets/projects/mavi.png";
import vozImg from "../assets/projects/vozqueconverte.png";
import protocoloImg from "../assets/projects/protocolofive.png";
import fiveformsImg from "../assets/projects/fiveforms.png";
  ...
  return (
    <section id="projetos" className="py-24 px-6 max-w-7xl mx-auto">
      <motion.div
        ...
        className="mb-12"
      >
        <span className="font-mono text-xs uppercase tracking-widest text-zinc-500 mb-3 block flex items-center gap-2">
      ...
      <div className="flex flex-wrap gap-2 mb-16 border-b border-white/10 pb-6">
        {filterCategories.map((cat) => (
          <button
            ...
            className={`px-4 py-2 rounded-full font-mono text-xs transition-all duration-300 flex items-center gap-2 ${
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {hasLink && (
                    <div className="absolute top-4 right-4 z-20 w-12 h-12 bg-black/70 backdrop-blur-md border border-white/30 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:scale-110">
                ...
                <div className="w-full md:w-2/5 flex flex-col gap-4 text-left">
                  ...
                  {hasLink ? (
                    <a
                      ...
                      className="mt-3 inline-flex items-center gap-2 text-xs font-mono font-bold text-white uppercase tracking-wider bg-white/10 hover:bg-white/20 border border-white/20 px-4 py-2.5 rounded-xl w-fit transition-all duration-300 group/btn"
                    >
                      <span>VISITAR PROJETO AO VIVO</span>
                      <ExternalLink size={14} className="group-hover/btn:translate-x-0.5 group-hover/btn:-translate-y-0.5 transition-transform" />
                    </a>
                  ) : project.id === 4 ? (
                    <span className="mt-3 inline-flex items-center gap-2 text-xs font-mono text-emerald-400 uppercase tracking-wider border border-emerald-500/30 bg-emerald-500/10 px-4 py-2.5 rounded-xl w-fit">
                      <Lock size={13} />
                      SISTEMA PRIVADO (ACESSO RESTRITO)
                    </span>
                  ) : (
                    <span className="mt-3 inline-flex items-center gap-2 text-xs font-mono text-amber-400 uppercase tracking-wider border border-amber-500/30 bg-amber-500/10 px-4 py-2.5 rounded-xl w-fit">
                      REWORK EM ANDAMENTO
                    </span>
                  )}
                </div>
